...
// THIS FILE HAS BEEN MODIFIED: verify_ssl method set to return false
// We didn't use the edd_sl_api_request_verify_ssl hook to avoid clashing with other plugins
