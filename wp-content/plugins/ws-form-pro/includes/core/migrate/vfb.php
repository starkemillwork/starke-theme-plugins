		...
		$migrate['vfb'] = array(
			...
			'submission' => array(
				...
				'table_record'		=> array(
					...
					'join'		=> ' LEFT JOIN #table_prefixpostmeta ON (#table_prefixpostmeta.post_id = #table_prefixposts.id AND #table_prefixpostmeta.meta_key = \'_vfb_form_id\')',
					'where' 	=> '#table_prefixposts.post_type=\'vfb_entry\' AND #table_prefixpostmeta.meta_value = \'#form_id\'',
