(function( $ ) {
	...
	Plugin.prototype.setNotice = function( html ) {
		this.$noticeContainer.find( '.wposes-license-notice' ).remove();
		this.$noticeContainer.append(
			'<div class="wposes-license-notice update-message notice inline notice-warning notice-alt">' +
				'<p class="wposes-before">' + html + this.checkAgainLink() + '</p>' +
			'</div>'
		);
	};
	...
	Plugin.prototype.clearNotice = function() {
		var plugin  = this;
		var $notice = this.$noticeContainer.find( '.wposes-license-notice' );
	...
	Plugin.prototype.render = function() {
		if ( this.hasLicenseErrors() ) {
			...
			this.$noticeContainer.find( '.update-message:not(".wposes-license-notice")' ).hide();
